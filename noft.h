...
extern "C" {
 ...
 void run_noft_c(int *INOF,int *Ista,int *NBF_tot,int *NBF_occ,int *Nfrozen, int *Npairs,
                 ...
                 int *ndiis,double *Enof,double *tolE,double *Vnn,double* Occ,double *NO_COEF_in,
                 int *restart,int *ireadGAMMAS,int *ireadocc,int *ireadCOEF,int *ireadFdiag,
                 int *iNOTupdateocc,int *iNOTupdateORB);
 void coef_2_hcore(double *NO_COEF_v,int *NBF);
 void hcore_ijkl(int *iorb, int *jorb, double *hVal);
