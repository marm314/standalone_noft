...
subroutine integ_init(INTEGd,NBF_tot,NBF_occ,iERItyp_in,Overlap_in,lowmemERI,complex_ints_in)
!Arguments ------------------------------------
!scalars
 logical,optional,intent(in)::lowmemERI,complex_ints_in
...
!************************************************************************
 ...
 if(present(complex_ints_in)) then
